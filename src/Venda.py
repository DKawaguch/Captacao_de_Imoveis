...
class Venda(QWidget):
    def __init__(self):
        ...
        self.parcela_input.setRange(0, 10000000)
    ...
    def collect_data(self):
        return{
            ...
            "fiador": None,
            "seguro_fianca": None,
            "adiantamento_alugueis": 0,
            "quitado": self.quitado_combo.currentText(),
            "financiamento_qtd_parcelas": self.financiado_input.value(),
            "financiamento_valor_parcela": self.parcela_input.value(),
